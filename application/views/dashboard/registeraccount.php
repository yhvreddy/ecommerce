            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Create New Dashboard Account</p>
                        ...
                        <form class="mt-3" method="POST" action="<?=base_url('dashboard/register-save')?>">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?=$this->security->get_csrf_hash(); ?>" />
                            
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="name" type="text" name="reg_name" required placeholder="Enter your name" value="<?=set_value('reg_name'); ?>">
                                        <?php echo form_error("reg_name", "<small class='error'>", "</small>"); ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="mobile" type="tel" name="reg_mobile" placeholder="Enter your mobile" maxlength="10" required value="<?= set_value('reg_mobile'); ?>">
                                        <?php echo form_error("reg_mobile", "<small class='error'>", "</small>"); ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="email" type="email" name="reg_email"
                                        placeholder="Enter your email" required value="<?= set_value('reg_email'); ?>">
                                        <?php echo form_error("reg_email", "<small class='error'>", "</small>"); ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="pwd" type="password" name="reg_password"
                                        placeholder="Enter your password" required>
                                        <?php echo form_error("reg_password", "<small class='error'>", "</small>"); ?>
                                    </div>
                                </div>
