...
class DefaultController extends CI_Controller 
{
	...
	* */
	...
	{
		$isLoggedIn = $this->session->userdata('admin');
		if (!isset($isLoggedIn) || $isLoggedIn['isAdminLogin'] != TRUE) {
	...
	public function logindetails(){
		$isLoggedIn = $this->session->userdata('admin');
		$userdata = $this->userdata('admins',$isLoggedIn['login_id']);
		return $userdata;
	}
	...
	* */
	...
	public function api_responce($data)
	{
